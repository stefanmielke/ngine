...
namespace ImGui
{
	...
	IMGUI_API void          StyleColorsDarkGray(ImGuiStyle* dst = NULL);    // new style, gray version
	...
	IMGUI_API void          SamePlace(float spacing=-1.0f);                                 // call between widgets or groups to layout them horizontally. X position given in window coordinates.
...
enum ImGuiInputTextFlags_
{
	...
	ImGuiInputTextFlags_CharsFilePathDFS    = 1 << 22	// Allow 0..9a..zA..z/_-.
